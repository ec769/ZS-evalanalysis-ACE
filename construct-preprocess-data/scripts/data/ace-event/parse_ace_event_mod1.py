...
class Document:
    def __init__(self, annotation_path, text_path, doc_key, fold, heads_only=True,
                 real_entities_only=True, include_pronouns=False, include_entity_coreference=True, include_event_coreference=False):
        '''
...
def one_fold(fold, output_dir, heads_only=True, real_entities_only=True, include_pronouns=False,
             include_entity_coreference=True, include_event_coreference=False):
